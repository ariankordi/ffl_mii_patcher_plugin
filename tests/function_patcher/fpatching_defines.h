/**
 * Version of fpatching_defines.h modified to work in the unit test.
 * https://github.com/wiiu-env/libfunctionpatcher/blob/5173f8609cdbd42c37b425967c4dd80468248e50/include/function_patcher/fpatching_defines.h
 */
#pragma once
...
typedef struct function_replacement_data_t {
    ...
    uintptr_t replaceAddr;  /* [needs to be filled] Address of our replacement function */
    uintptr_t *replaceCall; /* [needs to be filled] Address to access the real_function */
...
#define REPLACE_FUNCTION_EX(__replacementFunctionName, __lib, __function_name, \
    ...
    {                                                                          \
        ...
        .replaceAddr   = (uintptr_t) my_##__replacementFunctionName,            \
        .replaceCall   = (uintptr_t *) &real_##__replacementFunctionName,       \
